            ...
            <article className=" md:grid md:grid-cols-2 md:gap-16">
                ...
                <div className="flex flex-col justify-between xl:justify-start">
                    ...
                    <div className="flex gap-4 md:flex-col">
                        <button onClick={handleAddToCart} className="bg-gray-800 text-white w-full rounded-2xl py-4 px-4 text-2xl font-medium hover:bg-gray-700">Add to cart</button>
